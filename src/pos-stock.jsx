...
function PetShop({ stock, onCheckout, previewReceiptNo }) {
      ...
      <div className="card" style={{ overflow: 'hidden' }}>
        <table className="tbl">
          ...
          <tbody>
            ...
            {items.length === 0 ? <tr><td colSpan="8" style={{ textAlign: 'center', color: 'var(--ink-faint)', padding: 26 }}>ไม่พบสินค้า</td></tr> : null}
          </tbody>
        </table>
      </div>
